...
HOJASPAUTA::setDB($db);
NOVELA::setDB($db);
$hpautas = HOJASPAUTA::listarHojaPautaFechas($fecha, $novela);
...
<body>
    ...
    <main class="principal">
        ...
        <h3>HOJAS DE PAUTA DEL DÍA <?php echo date("d-m-Y", strtotime("$fecha")); ?></h3>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="pauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&fecha=<?php echo $fecha; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="editpauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&fecha=<?php echo $fecha; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="elimpauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&fecha=<?php echo $fecha; ?>&indice=<?php echo $indice; ?>">
