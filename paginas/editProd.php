...
NOVELA::setDB($db);
$novelaEdit = NOVELA::listarNovelaId($novelaEnv);
                    ...
                    <form method="POST">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="novela" name="novela" value="<?php echo $novelaEdit->novela; ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="director" name="director" value="<?php echo $novelaEdit->director_n; ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="df" name="df" value="<?php echo $novelaEdit->df_n; ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="script" name="script" value="<?php echo $novelaEdit->script_n; ?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input">
                                        <input type="text" class="field" id="sonido" name="sonido" value="<?php echo $novelaEdit->sonido_n; ?>">
                                    </div>
                                </td>
                            </tr>
                        </table>
