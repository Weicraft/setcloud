        ...
        <div class="contenedor panel">
            <div class="contenedor formulario">
                ...
                <form method="POST">
                    ...
                    <div class="object-center-evenly margin-top-mayor">
                        <input class="boton-grabar" type="submit" value="Guardar" id="actualizar-registro">
                        <a href="gestUser.php" class="boton-salir">Salir</a>
                    </div>
                </form>
