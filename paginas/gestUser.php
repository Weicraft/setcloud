...
<body>
    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <a href="nuevouser"><button class="boton-agregar">+ Agregar Nuevo Usuario</button></a>
                        ...
                        <td><?php echo $usuario->cargo; ?></td>
                            <td>
                                <div class="flex-simple-center">
                                    <a href="edituser?id_user=<?php echo $usuario->id_user; ?>">
                            ...
                            <td class="flex-simple-center">
                                <a href="editpass?id_user=<?php echo $usuario->id_user; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="permisos?usuario=<?php echo $usuario->usuario; ?>">
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="elimuser?id_user=<?php echo $usuario->id_user; ?>">
