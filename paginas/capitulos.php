...
NOVELA::setDB($db);
$capitulos = REGISTROPAUTAS::listarCapitulos($novela);
...
<body>
    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <h3>HOJAS DE PAUTA CLASIFICADAS POR CAPÍTULOS</h3>
            ...
            <?php if ($capitulos) { ?>
                <div class="contenedor-fechas">
                    ...
                    foreach ($capitulos as $capitulo) :
                        ...
                        echo '<a class="fecha-item" href="pautascapitulos?capitulo=' . urlencode($cap) . '&novela=' . $novela .'">
            <svg fill="#a6c8ff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M10 4H2v16h20V6H12l-2-2z"/>
            </svg>
            <span class="fecha-texto">Capítulo ' . $cap . '</span>
        </a>';
                    endforeach;
                    ?>
                </div>
