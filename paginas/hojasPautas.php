...
HOJASPAUTA::setDB($db);
NOVELA::setDB($db);
$hpautas = HOJASPAUTA::listarHojaPauta($novela);
...
<body>
    ...
    <main class="principal">
        <div class="contenedor tablas">
            ...
            <h3>TODAS LAS HOJAS DE PAUTA</h3>
            <?php include 'templates/barranav.php'; ?>
            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                <a href="nuevapauta?novela=<?php echo $novela; ?>&indice=<?php echo $indice; ?>"><button class="boton-agregar">+ Agregar Nueva</button></a>
            <?php }
            if ($hpautas) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-simple-center">
                                    <a href="pauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&indice=<?php echo $indice; ?>">
                            ...
                            <?php if ($sesionSeccion->estado_sesion == '1') { ?>
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="editpauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&indice=<?php echo $indice; ?>">
                                ...
                                <td>
                                    <div class="flex-simple-center">
                                        <a href="elimpauta?hpauta=<?php echo $hpauta->id_hpauta; ?>&novela=<?php echo $novela; ?>&indice=<?php echo $indice; ?>">
